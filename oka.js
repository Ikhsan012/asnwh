...
const reply = (teks) => {
return okta.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `halo saya ${botname}🌹`,"body": `Selamat ${ucapanWaktu} kak ${pushname}`, mediaType: 1, renderLargerThumbnail: true, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/7537a9c91e5e0bfb05ca5.jpg',"thumbnail": thumb,"sourceUrl": `https://whatsapp.com/channel/0029VaMXy2I0wak0RDGOzH3z`}}}, { quoted:m})} 
...
sourceUrl: `https://wa.me/6288210180505`,
}}}, { quoted: m })}
/*const taaReply = (teks) => {
    return okta.sendMessage(from, {text: teks, contextinfo: {
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;TaaOfc,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/3c485ff201d9337be14ef.jpg' }}}}
...
var taaofc = [
 ...
 '..',
 '...',
 'ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️Loading selesai!'
]
...
title: botname,
body: `ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️`,
thumbnail: thum,
mediaType: 1,
thumbnailUrl: "",
renderLargerThumbnail: true,
sourceUrl: `https://whatsapp.com/channel/0029VaMXy2I0wak0RDGOzH3z`,
}}}, { quoted: fkontak })
 ...
 *_https://chat.whatsapp.com/FwlTKjf5MoE1kjAc84FCqx_*
•-------------------------------------------------•`
                        }
                    },
...
reply(`
┏❏═┅═━–〈 Iɴғᴏ
┆ ☂︎ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️
┆ ☂︎ 𝚄𝚜𝚎𝚛 : ${pushname}
┆ ☂︎ 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 : ${isPrem ? '✅' : '❎'}
┆ ☂︎ 𝚃𝚊𝚗𝚐𝚐𝚊𝚕: ${hariini}
┆ ☂︎ 𝙹𝚊𝚖: ${time} WIB❄️
...
⭔Nama Script : *ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️*
⭔Versi Script : *2.0*
⭔Botz Name : *ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️*
⭔Type Baileys : *Case*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
...
sourceUrl: "https://chat.whatsapp.com/CAaHTC4unnCCcZN70qRRgZ",
mediaType: 1,
renderLargerThumbnail: true
}}}, {quoted:m})
...
//=================================================//
        ...
        case 'addprem':
if (!isCreator) return errorReply(mess.owner)
if (!args[0]) return reply(`Use ${prefix+command} number\nExample ${prefix+command} 6288210180505`)
...
⭔Versi Bot : *2.3*
⭔Botz Name : *ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️*
⭔Nomor Bot : *wa.me/62882101805056*
⭔Type Baileys : *Case*
⭔Source Code : *${okta}*
...
Terima Kasih sudah mendaftar ke dalam bot ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️.
...
await loading()
m.reply(`¥ *Price Sewa Bot ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️* €
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️`);
});
}
...
mediaType:  1,
mediaUrl: 'https://wa.me/6288210180505',
title: `ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️`,
sourceUrl: `https://wa.me/6288210180505`, 
thumbnail: thumb
}
}})
...
okta.sendMessage(from, {image: { url: result }, caption: 'ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
MINAT CHAT : 
https://wa.me/6288210180505`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/fc3e9c17774299a3ba063.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
/////=================///////////
case "disney": {
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Menambahkan Pdf\nCek dengan cara ${prefix}listpdf`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses delete pdf ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Mengirim Pesan Pdf Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Menambahkan zip\nCek dengan cara ${prefix}listzip`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses delete zip ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Mengirim Pesan Zip Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Menambahkan apk\nCek dengan cara ${prefix}listapk`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses delete Apk ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Mengirim Pesan Apk Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Menambahkan Audio\nCek dengan cara ${prefix}listvn`)
}
break
//=================================================//
case 'delvn':{
...
reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses delete vn ${text}`)
}
break
//=================================================//
case 'listvn':{
...
await loading()
 ...
 m.reply(`ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses Mengirim Pesan Ke ${m.quoted.sender}`)
}
break
//=================================================//
case 'listmsg': {
...
m.reply(`*ᴘʀᴏᴊᴇᴄᴛ Ikhsan-Dev ❄️ Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case "buatswimage":{
if (!isCreator) return m.reply('*Khusus Premium*')
